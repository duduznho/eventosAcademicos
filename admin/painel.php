...
$getexe = filter_input(INPUT_GET, 'exe', FILTER_SANITIZE_STRIPPED);
        ...
        <header id="navadmin">
            <div class="content">
                ...
                <nav>
                    ...
                    <ul class="menu">
                        <li class="li<?php if (in_array('eventos', $linkto)) echo ' active'; ?>"><a class="opensub" onclick="return false;" href="#">Eventos</a>
                            <ul class="sub">
                                <li><a href="painel.php?exe=eventos/create">Criar Evento</a></li>
                                <li><a href="painel.php?exe=eventos/index">Listar / Editar</a></li>
                            </ul>
                        </li>
